          ...
          <div className="rounded-xl border border-gray-100 bg-[#4FC3F7] p-3.5 shadow-sm sm:p-4.5">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="rounded-lg border bg-gray-50 p-2.5 sm:p-3.5">
                ...
                <a href="/pdf/application.pdf" target="_blank" className="text-xs text-primary hover:underline sm:text-sm">
                  Download PDF
                </a>
              </div>

              <div className="rounded-lg border bg-gray-50 p-2.5 sm:p-3.5">
                <p className="text-xs font-medium sm:text-sm">Prospectus</p>
                <a href="/pdf/prospectus.pdf" target="_blank" className="text-xs text-primary hover:underline sm:text-sm">
                  Download PDF
                </a>
              </div>
        ...
        <div className="flex flex-col gap-4 sm:gap-5 lg:hidden">
          ...
          <div className="rounded-xl border border-gray-100 bg-[#4FC3F7] p-3.5 shadow-sm sm:p-4.5">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="rounded-lg border bg-gray-50 p-2.5 sm:p-3.5">
                <p className="mb-1 text-xs font-medium sm:text-sm">Prospectus</p>
                <a href="/pdf/prospectus.pdf" target="_blank" className="text-xs text-primary hover:underline sm:text-sm">
                  Download PDF
                </a>
              </div>
