        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="mx-auto max-w-7xl px-3 pt-4 sm:px-5 sm:pt-6 md:px-6 md:pt-8">
                <div className="inline-flex items-center gap-1.5 rounded-lg border border-gray-100 bg-white px-2.5 py-1.5 shadow-sm sm:gap-2 sm:px-4 sm:py-2.5">
                    ...
                    <Link
                        href="/"
                        className="text-[11px] font-medium text-gray-500 transition hover:text-primary sm:text-xs md:text-sm"
                    >
                        Home
                    </Link>
            ...
            <div className="mx-auto flex max-w-7xl flex-col gap-6 px-3 py-6 sm:px-5 sm:py-7 md:px-6 md:py-8 lg:flex-row lg:gap-7 lg:py-9">
                            ...
                            <div className="mt-3 flex flex-col gap-2">
                                {aboutLinks.map((item) => (
                                    <Link
                                        key={item.name}
                                        href={item.href}
                                        className="rounded-md px-2.5 py-1.5 text-xs transition hover:bg-white/10 sm:px-3 sm:py-2 sm:text-sm"
                                    >
                                        {item.name}
                                    </Link>
                                ))}
                ...
                <div className="hidden w-[220px] min-w-[220px] flex-col gap-4 lg:flex xl:w-[240px] xl:min-w-[240px] sm:gap-5">
                    <div className="h-fit w-full rounded-xl bg-primary p-3.5 text-white shadow-md sm:p-4.5 xl:p-5">
                        <h2 className="mb-3 text-sm font-semibold tracking-wide sm:mb-4 sm:text-base xl:text-lg">
                            About Us
                        </h2>
                    ...
                    <div className="rounded-xl border border-gray-100 bg-[#4FC3F7] p-3.5 shadow-sm sm:p-4.5">
                        <h3 className="mb-3 text-sm font-semibold sm:mb-4 sm:text-base xl:text-lg">
                ...
                <div className="flex-1 rounded-xl border border-gray-100 bg-white p-4 shadow-sm sm:p-6 lg:p-8">
                    ...
                    <h1 className="mb-4 text-lg font-bold text-primary sm:mb-6 sm:text-xl md:text-2xl lg:mb-7 lg:text-[28px]">
                        {title}
                    </h1>
